...
function SIngleVideoPlaybackDetails({ data, index, currentIndex, businessData }) {
  ...
  return (
    <div className="single-video-playback-details">
...
export default SIngleVideoPlaybackDetails;
